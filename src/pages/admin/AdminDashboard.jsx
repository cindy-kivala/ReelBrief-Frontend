...
import Layout from "@/components/layout/Layout"; // ✅ Use shared layout
        ...
        <section className="mt-10 bg-white p-6 rounded-xl border border-gray-300">
          ...
          <div className="flex flex-col gap-5">
            {recentProjects.map((project) => (
              <div
                key={project.id}
                className="border border-gray-300 rounded-xl p-4 hover:border-blue-400"
              >
                ...
                <p className="text-gray-600 text-sm">
                  Budget: ${project.budget} • Requested{" "}
                  {new Date(project.requested_at).toLocaleDateString()}
                </p>
