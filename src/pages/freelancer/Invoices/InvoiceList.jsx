...
const FreelancerInvoiceList = () => {
  ...
  return (
    <Layout> {/* ✅ Wrapped everything inside Layout */}
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-semibold">My Invoices</h2>
          <Link
            to="/freelancer/invoices/create"
        ...
        {loading ? (
          <p className="text-center mt-8">Loading invoices...</p>
        ) : invoices.length === 0 ? (
          <p>No invoices yet.</p>
        ) : (
              ...
              <tbody>
                {invoices.map((inv) => (
                  <tr key={inv.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4">{inv.project?.title || "—"}</td>
